...
class ModuleManager
{
 ...
 void ModuleManager(){RegisterModules();} void ~ModuleManager(){m_Modules.Clear();delete m_Modules;} void RegisterModule(Module module){m_Modules.Insert(module);}
...
RegisterModule(new CustomDebugMonitor);
 ...
 void ReloadSettings(){} array< ref Module > GetModules(){return m_Modules;}
